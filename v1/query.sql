-- mysql
CREATE DATABASE lpinto_backed_v1_71;
CREATE USER 'lpinto_backend_v1_71'@'localhost' IDENTIFIED BY 'lpinto-c11s4';
GRANT ALL PRIVILEGES ON lpinto_backed_v1_71.* TO 'lpinto_backend_v1_71'@'localhost';
FLUSH PRIVILEGES;
